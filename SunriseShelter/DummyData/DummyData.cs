...
namespace Sunrise_Shelter.Data
{
    public class DatabaseStartup
    {
        public static void StartUp(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                {
                    new Parent { FirstName = "John", LastName = "Doe", DateOfBirth = new DateTime(1999, 3, 23), Phone = "02102333333", Email = "JohnDoe@gmail.com", MartialStatus = "Single", Address = "New Lynn", Country = "New Zealand" },
                    new Parent { FirstName = "Alice", LastName = "Smith", DateOfBirth = new DateTime(1985, 7, 12), Phone = "0210456789", Email = "alice.smith@example.com", MartialStatus = "Married", Address = "Epsom", Country = "New Zealand" },
                    new Parent { FirstName = "Bob", LastName = "Johnson", DateOfBirth = new DateTime(1990, 5, 14), Phone = "0210789654", Email = "bob.johnson@example.com", MartialStatus = "Divorced", Address = "Mt Albert", Country = "New Zealand" },
                    new Parent { FirstName = "Carol", LastName = "Williams", DateOfBirth = new DateTime(1978, 11, 25), Phone = "0210567345", Email = "carol.w@example.com", MartialStatus = "Single", Address = "Manukau", Country = "New Zealand" },
                    new Parent { FirstName = "David", LastName = "Brown", DateOfBirth = new DateTime(1992, 2, 19), Phone = "0210452389", Email = "david.b@example.com", MartialStatus = "Married", Address = "Henderson", Country = "New Zealand" },
                    new Parent { FirstName = "Emily", LastName = "Clark", DateOfBirth = new DateTime(1983, 10, 5), Phone = "0210987654", Email = "emily.c@example.com", MartialStatus = "Widowed", Address = "Takapuna", Country = "New Zealand" },
                    new Parent { FirstName = "Frank", LastName = "Evans", DateOfBirth = new DateTime(1987, 6, 20), Phone = "0210678945", Email = "frank.e@example.com", MartialStatus = "Married", Address = "Albany", Country = "New Zealand" },
                    new Parent { FirstName = "Grace", LastName = "Hall", DateOfBirth = new DateTime(1995, 8, 11), Phone = "0210563214", Email = "grace.h@example.com", MartialStatus = "Single", Address = "Papakura", Country = "New Zealand" },
                    new Parent { FirstName = "Henry", LastName = "Lewis", DateOfBirth = new DateTime(1980, 4, 15), Phone = "0210784321", Email = "henry.l@example.com", MartialStatus = "Married", Address = "Botany", Country = "New Zealand" },
                    new Parent { FirstName = "Isabel", LastName = "Martinez", DateOfBirth = new DateTime(1991, 12, 3), Phone = "0210458765", Email = "isabel.m@example.com", MartialStatus = "Single", Address = "Glenfield", Country = "New Zealand" }
                };
...
{
                    new Children { Name = "James", DateOfBirth = new DateTime(2014, 3, 23, 9, 15, 0), DateOfAdmission = new DateTime(2018, 4, 19, 8, 11, 0) },
                    new Children { Name = "Sophia", DateOfBirth = new DateTime(2015, 5, 10, 7, 30, 0), DateOfAdmission = new DateTime(2019, 6, 15, 9, 45, 0) },
                    new Children { Name = "Liam", DateOfBirth = new DateTime(2013, 8, 2, 11, 20, 0), DateOfAdmission = new DateTime(2017, 7, 12, 10, 30, 0) },
                    new Children { Name = "Emma", DateOfBirth = new DateTime(2016, 2, 5, 5, 50, 0), DateOfAdmission = new DateTime(2020, 1, 18, 6, 0, 0) },
                    new Children { Name = "Oliver", DateOfBirth = new DateTime(2017, 10, 14, 8, 5, 0), DateOfAdmission = new DateTime(2021, 3, 2, 7, 25, 0) },
                    new Children { Name = "Ava", DateOfBirth = new DateTime(2014, 11, 30, 6, 45, 0), DateOfAdmission = new DateTime(2018, 9, 25, 5, 40, 0) },
                    new Children { Name = "Ethan", DateOfBirth = new DateTime(2015, 6, 28, 4, 55, 0), DateOfAdmission = new DateTime(2019, 4, 17, 2, 10, 0) },
                    new Children { Name = "Mia", DateOfBirth = new DateTime(2016, 7, 19, 12, 30, 0), DateOfAdmission = new DateTime(2020, 12, 4, 1, 35, 0) },
                    new Children { Name = "Benjamin", DateOfBirth = new DateTime(2017, 1, 3, 10, 15, 0), DateOfAdmission = new DateTime(2021, 5, 10, 9, 0, 0) },
                    new Children { Name = "Charlotte", DateOfBirth = new DateTime(2014, 4, 25, 6, 5, 0), DateOfAdmission = new DateTime(2018, 8, 29, 4, 50, 0) }
};
